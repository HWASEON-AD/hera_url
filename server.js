 ...
 *  보안/관리자 설정 (환경변수 지원)
 *  ========================= */
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'hera@00';
...
app.use(cors({
  origin: process.env.NODE_ENV === 'production'
    ? ['https://hera-url.onrender.com', 'https://hera-url.com']
    : ['http://localhost:5001'],
  credentials: true,
...
app.post('/api/admin/login', (req, res) => {
  ...
  const adminUser = { id: 'admin', username: '김성은', email: 'gt.min@hawseon.com', isAdmin: true };
...
const BASE_URL = process.env.NODE_ENV === 'production'
  ? (process.env.DOMAIN || 'https://hera-url.com')
  : `http://localhost:${PORT}`;
